...
angular.module('tink.datepicker')
	...
	.provider('$datepicker', function () {
		...
		this.$get = function ($window, $document, $rootScope, $sce, $dateFormatter, datepickerViews, $tooltip, $timeout) {
			...
			console.log($dateFormatter.getDefaultLocale())
	...
	.provider('datepickerViews', function () {
		...
		this.$get = function ($dateFormatter, $dateParser, $sce,dateLang) {
			...
			return function (picker) {
              ...
              console.log(firstDate)
							...
							var daysToDraw = $dateFormatter.daysInMonth(viewDate.month+1,viewDate.year)+$dateFormatter.daysBetween(firstDate,firstDayOfMonth);
							if(daysToDraw%7 !== 0){
                daysToDraw+=7-(daysToDraw%7);
              }
              console.log($dateFormatter.daysInMonth(viewDate.month+1,viewDate.year),$dateFormatter.daysBetween(firstDate,firstDayOfMonth),7-(daysToDraw%7))
							var days = [], day;
					...
					},
					{
						...
						build: function () {
							...
							for (var i = 0; i < 12; i++) {
								...
								months.push({date: month, label: dateLang.getShortMonths(lang)[i], selected: picker.$isSelected(month), disabled: this.isDisabled(month)});
							}
	...
	.service('$dateFormatter', function ($locale, dateFilter,dateLang) {
		...
		this.weekdaysShort = function (lang) {
			...
			switch (new Date().getDay()) {
				case 'NL':
				default:
					Weekarray = 'Zo,Ma,Di,Woe,Do,Vri,Zat'.split(',');
					;
					break;
			}
			return Weekarray;
		...
		this.daysBetween = function(first,last) {
		...
		this.formatDate = function (date, format, lang) {
			return dateLang.format(date, format,lang);
		};
