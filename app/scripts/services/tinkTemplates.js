...
$templateCache.put('templates/tinkDatePickerRangeInputs.html',
  ...
  '</div>'+
  '<div class="col-sm-6">'+
    '<input type="text" id="lastDateElem" data-date data-format="00/00/0000" data-placeholder="dd/mm/jjjj" tink-format-input dynamic-name="dynamicName" ctrl-model="dynamicName" valid-name="last"  ng-model="lastDate">'+
    '<span class="datepicker-icon">'+
      '<i class="fa fa-calendar"></i>'+
    '</span>'+
  '</div>'+
