  ...
  .provider('datepickerViews', function () {
    ...
    var defaults = this.defaults = {
      ...
      this.$get = function ($dateFormatter, $dateParser, $sce, dateParser) {
            ...
            },
            {
              ...
              build: function () {
                ...
                for (var i = 0; i < 12; i++) {
                  ...
                  months.push({
                    date: month,
                    label: dateParser.getShortMonths(lang)[i],
  ...
  .service('$dateFormatter', function ($locale, dateFilter, dateParser) {
      ...
      this.formatDate = function (date, format, lang) {
        return dateParser.format(date, format);
      };
