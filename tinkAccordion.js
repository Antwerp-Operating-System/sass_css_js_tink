...
describe('tinkaccordion', function() {
  ...
  var templates = {
    'default': {
      scope: {togle:true,onceAta:true},
      element: '<tink-accordion data-one-at-a-time="onceAta">'+
  ...
  describe('with default template', function() {
    ...
    it('should start with 2 open', function() {
      var elm = compileDirective('default');
      expect(sandboxEl.find('.group-open').length).toBe(2);
    });

    it('should start with none open', function() {
      var elm = compileDirective('default');
